	...
	<div id="sim_expired_list">
		<div style="display:flex;flex-direction:column;width:100%;height:100%;">
			...
			<div style="display:flex;flex-direction:row;margin-bottom:10px;" ref="topBar">
				...
				<el-button type="primary" @click="btnRemindLater">7天后再提醒我</el-button>
				<el-button type="primary" @click="btnDontRemind">永远不要再提醒我</el-button>
			</div>
...
<script type="text/javascript" src="sim_expired_list.js"></script>