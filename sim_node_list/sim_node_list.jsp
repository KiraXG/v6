	...
	<div style="display:flex;flex-direction:column;width:100%;height:100%;">
		...
		<template>
			<el-table :data="simTableData" style="width:100%" border ref="simList" height=100%
				...
				<el-table-column prop="iccid" label="ICCID" width="140" fixed></el-table-column>
				...
				<el-table-column prop="company" label="公司" width="150"></el-table-column>
      			...
      			<el-table-column prop="group" label="工位号" width="120"></el-table-column>
      			<el-table-column prop="used_flow" label="已用" width="80"></el-table-column>
      			<el-table-column prop="total_flow" label="总量" width="80"></el-table-column>
...
<script type="text/javascript" src="sim_node_list.js"></script>